...
You will have to use FastTree on the terminal (MacOS and Linux) or the Command Prompt (Windows)
...
Please make SURE that all packahes are correctly installed, by running these lines in R:
